...
export type CityWhereInput = {
  ...
  codeInsee?: Prisma.StringFilter<"City"> | string
  name?: Prisma.StringFilter<"City"> | string
  zipCode?: Prisma.StringFilter<"City"> | string
...
export type CityScalarWhereWithAggregatesInput = {
  ...
  codeInsee?: Prisma.StringWithAggregatesFilter<"City"> | string
  name?: Prisma.StringWithAggregatesFilter<"City"> | string
  zipCode?: Prisma.StringWithAggregatesFilter<"City"> | string
...
export interface CityDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `codeInsee`
   * const cityWithCodeInseeOnly = await prisma.city.findMany({ select: { codeInsee: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Cities and only return the `codeInsee`
   * const cityWithCodeInseeOnly = await prisma.city.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Cities and only return the `codeInsee`
   * const cityWithCodeInseeOnly = await prisma.city.updateManyAndReturn({
   *   select: { codeInsee: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CityFieldRefs {
  readonly codeInsee: Prisma.FieldRef<"City", 'String'>
  readonly name: Prisma.FieldRef<"City", 'String'>
  readonly zipCode: Prisma.FieldRef<"City", 'String'>
